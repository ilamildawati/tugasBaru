                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Prodi Sistem Informasi</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">Mahasiswi Semester 4</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">UNIVERSITAS MERCUBUANA
                                    YOGYAKARTA</span></h1>
                            <div
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-2 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('assets/assets/profil.png') }}" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">Hello It's Me Sila Mildawati</p>
                            <p class="text-muted">Seorang mahasiswi universitas mercubuana yogyakarta,jurusan sistem informasi
                                sya tertarik dengan sistem informasi. saya telah belajar tentang konsep dasar dalam
